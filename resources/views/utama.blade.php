...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-center" style="width: 34%;" >
        <nav id="navmenu" class="navmenu" class="mx-auto">
          <ul>
            ...
            <li><a href="{{ route('login') }}">Pengajuan</a></li>
      ...
      <div class="d-flex justify-content-end" style="width: 33%; padding-right: 30px;">
        <a class="btn-getstarted" href="{{ route('login') }}" method="post">Login</a>
      </div>
  ...
  <!-- Vendor JS Files -->
  <script src="pengguna/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="pengguna/vendor/php-email-form/validate.js"></script>
  <script src="pengguna/vendor/aos/aos.js"></script>
  <script src="pengguna/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="pengguna/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="pengguna/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="pengguna/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
  <script src="pengguna/vendor/isotope-layout/isotope.pkgd.min.js"></script>
