    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.beranda') }}">Lain Mata</a>
                <a class="navbar-brand hidden" href="{{ route('admin.beranda') }}"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    <li>
                        ...
                        <ul class="submenu" style="display: none; padding-left: 40px;">
                            <li>
                                <a href="{{ route('admin.keseluruhan.tabel') }}" style="display: flex; align-items: center;">
                                    <i class="fa fa-table" style="margin-right: 21px;"></i> Data Tabel
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.keseluruhan.visual') }}" style="display: flex; align-items: center;">
                    ...
                    <li>
                        <a href="{{ route('admin.pengajuan') }}" style="display: flex; align-items: center;">
