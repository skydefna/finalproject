                ...
                $(document).ready(function () {
                    var table = $('#bootstrap-data-table').DataTable({
                        ...
                        initComplete: function () {
                            // Tambahkan filter ke baris atas kanan
                            this.api().columns().every(function (index) {
                                if (index === 6) { // Kolom Desa/Kelurahan
                                    var column = this;

                                    // Buat dropdown
                                    var select = $('<select class="form-select form-select-sm ms-3" style="width:auto; display:inline;"><option value="">-- Semua Desa/Kelurahan --</option></select>')
                                        .appendTo($('#bootstrap-data-table_filter')) // disisipkan di area search
                                        .on('change', function () {
