    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-center" style="width: 34%;" >
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="{{ route('teknisi.beranda') }}" class="active">Beranda<br></a></li>
            <li><a href="#tentang">Tentang</a></li>
            <li class="dropdown"><a href="#"><span>Data Teknisi</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-submenu" style="left: 100%; top: 0;">
                    <li><a href="{{ route('teknisi.keseluruhan.tabel') }}">Data Tabel</a></li>
                    <li><a href="{{ route('teknisi.keseluruhan.visual') }}">Data Visual</a></li>
                  </ul>
                </li>
                <li><a href="{{ route('teknisi.pengajuan') }}">Data Pengajuan</a></li>
                <li><a href="{{ route('teknisi.data') }}">Data Lapangan</a></li>
              </ul>
            </li>
