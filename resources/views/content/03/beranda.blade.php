    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-center" style="width: 34%;" >
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="{{ route('pimpinan.beranda') }}" class="active">Beranda<br></a></li>
            <li><a href="#tentang">Tentang</a></li>
            <li class="dropdown"><a href="#"><span>Data Pimpinan</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-submenu" style="left: 100%; top: 0;">
                    <li><a href="{{ route('pimpinan.keseluruhan.tabel') }}">Data Tabel</a></li>
                    <li><a href="{{ route('pimpinan.keseluruhan.visual') }}">Data Visual</a></li>
                  </ul>
                </li>
                <li><a href="{{ route('pimpinan.pengajuan') }}">Data Pengajuan</a></li>
                <li><a href="{{ route('pimpinan.teknisi') }}">Data Teknisi</a></li>
              </ul>
            </li>
      ...
      @foreach($db->lokasi as $lok)
        @if(!empty($lok->latitude) && !empty($lok->longitude))
          var customIcon = L.divIcon({
            className: '',
            html: `<img src="https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-{{ $iconColor }}.png" style="display:block; margin: 0 auto;" />`,
            iconSize: [25, 55],
            iconAnchor: [12, 55],
          });
