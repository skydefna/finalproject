                                ...
                                @foreach ($survei as $id => $db)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <form action="{{ route('pengajuan.status.update', $db->pengajuan_id) }}" method="POST">
                                                @csrf
                                                <select name="status_id" class="form-control font-weight-bold" onchange="this.form.submit()">
                                                    @foreach ($status as $statusOption)
                                                        @php
                                                            $currentStatusId = optional($db->pengajuan->status->first())->id_status;
                                                        @endphp
                                                        <option value="{{ $statusOption->id_status }}"
                                                            {{ $currentStatusId == $statusOption->id_status ? 'selected' : '' }}>
