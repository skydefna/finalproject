...
class DashboardController extends Controller
{
    public function beranda()
    {
        ...
        return view('content.03.beranda', compact('pengajuan', 'jumlahDisetujui', 'rekapPerKecamatan', 'rekapPerDesa'));
    }
        ...
        return view('content.03.data_visual', compact('jumlahPengajuan', 'jumlahDiajukan', 'jumlahDisetujui', 
